...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1181.054105273346; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1725.0757452075102; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 9.14668718379389; // x position of the perpendicular encoder (in tick units)
    }
